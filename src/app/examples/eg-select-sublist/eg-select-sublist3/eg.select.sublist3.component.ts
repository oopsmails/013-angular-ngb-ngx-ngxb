...
@Component({
  selector: 'app-eg-select-sublist3',
  templateUrl: './eg.select.sublist3.component.html',
  styleUrls: ['./eg.select.sublist3.component.scss'],
})
export class ExamplesSelectSublist3Component implements OnInit {
  branches: Branch[] = [
    {
      branchName: 'Branch 1',
