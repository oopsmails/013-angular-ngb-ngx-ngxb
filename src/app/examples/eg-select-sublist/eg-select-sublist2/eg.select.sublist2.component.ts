...
@Component({
  selector: 'app-eg-select-sublist2',
  templateUrl: './eg.select.sublist2.component.html',
  styleUrls: ['./eg.select.sublist2.component.scss'],
})
export class ExamplesSelectSublist2Component implements OnInit {
  branches: Branch[] = [
    {
      branchName: 'Branch 1',
