...
@Component({
  ...
  templateUrl: './ngxb.typeahead.search.preview.component.html',
  styleUrls: ['./ngxb.typeahead.search.preview.component.scss'],
})
export class NgxbTypeaheadSearchPreviewComponent {
