...
@Component({
  selector: 'app-home-table1',
  templateUrl: './h.table1.component.html',
  styleUrls: ['./h.table1.component.scss'],
})
export class HomeTable1Component implements OnInit, OnDestroy {
