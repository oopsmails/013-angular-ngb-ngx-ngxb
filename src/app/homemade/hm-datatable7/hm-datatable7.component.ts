...
@Component({
  selector: 'app-hm-datatable7',
  templateUrl: './hm-datatable7.component.html',
  styleUrls: ['./hm-datatable7.component.scss'],
})
export class HmDatatable7Component implements OnInit {
  private COMPONENT_NAME = 'HmDatatable7Component';
