...
@Component({
  selector: 'app-hm-datatable8',
  templateUrl: './hm-datatable8.component.html',
  styleUrls: ['./hm-datatable8.component.scss'],
})
export class HmDatatable8Component implements OnInit {
  private COMPONENT_NAME = 'HmDatatable8Component';
